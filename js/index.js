...
function findMovies(id) {
  ...
  "-"
      ...
      <div class="row">
        <span class="badge badge-alert"><span id="status">${featureMovie.status}</span>
        </span>
      </div>
      <div class="row">
        <p>${runtimeString} | ${genreString} | ${releaseDate}</p>
      </div>
      ...
      <div class="row">
        <span class="badge badge-info"><a href="${featureMovie.homepage}" target="_blank">Website</a>
        </span>
      </div>
      <div class="row">
